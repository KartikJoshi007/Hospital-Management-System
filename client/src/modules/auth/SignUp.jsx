...
import { Mail, Lock, User, Phone, Activity, ArrowRight, Eye, EyeOff, ShieldCheck } from 'lucide-react'
...
function SignUp() {
  ...
  const handleSubmit = (e) => {
    ...
    localStorage.setItem('pendingUsers', JSON.stringify([...existing, newUser]))
    navigate('/login')
  }

  const inputBase = 'w-full pl-12 pr-4 py-4 bg-white border border-slate-200 rounded-2xl focus:outline-none focus:ring-4 focus:ring-emerald-500/10 focus:border-emerald-500 transition-all text-sm font-bold text-slate-900 shadow-sm'
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full pl-12 pr-12 py-4 bg-white border rounded-2xl focus:outline-none focus:ring-4 transition-all text-sm font-bold text-slate-900 shadow-sm [&::-ms-reveal]:hidden [&::-ms-clear]:hidden ${
        ...
        <div className="hidden md:flex flex-col justify-between bg-slate-900 p-12 relative overflow-hidden text-white order-1 md:order-2">
          ...
          <div className="relative z-10 mt-20">
            ...
            <p className="text-sm font-medium text-slate-400 max-w-md leading-relaxed">
              Register as a patient to book appointments, view your medical records, and manage your health journey — all in one place.
            </p>
          </div>
          ...
          <div className="relative z-10 p-6 bg-white/5 rounded-3xl border border-white/10 backdrop-blur-sm mt-12 w-max shadow-xl">
            <div className="flex items-center gap-4 mb-3">
              ...
              <div className="text-xs font-black uppercase tracking-widest">Patient Portal</div>
            </div>
            <p className="text-[10px] font-bold text-slate-400 max-w-[220px] leading-relaxed">
              For doctors and staff accounts, please contact your hospital administrator.
            </p>
          </div>
        </div>
      </motion.div>
